...
import { getFile, postFiles, getFolder } from '../controllers/filesController.ts'
...
router.post('/files', upload.files([{name: 'userFiles' }]), postFiles) //Upload a file to the system, the file will be distributed to the nodes based on their available space and load
